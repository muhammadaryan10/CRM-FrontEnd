...
const InventroyListTech = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/all_inventory_info`);
      if (!res.ok) {
  ...
  return (
    <div className='flex h-[100vh] bg-black'>
      ...
      <div className=' rounded-xl m-2 p-2 w-100 overflow-y-scroll bg-gray-300'>
        ...
        <h1 className='text-4xl font-bold text-uppercase text-black py-3 mt-3'>Inventory Information</h1>
