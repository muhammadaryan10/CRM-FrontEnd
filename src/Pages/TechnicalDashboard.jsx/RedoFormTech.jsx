    ...
    <div className='p-3'>
      ...
      <div className='flex grid lg:grid-cols-2 md:grid-cols-1 gap-x-4'>
        <div className=' flex flex-col justify-center'>
          ...
          <div className='flex justify-center my-2'><p className='text-end md:text-start text-sm' style={{ width: "40%" }}> New Device :</p><input onChange={getUserdata} name="new_device" className=' ml-3 custum_input p-1 ' style={{ width: "55%" }} /> </div>
        </div >
