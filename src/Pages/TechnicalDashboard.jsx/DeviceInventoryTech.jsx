    ...
    return (
        <div>
            ...
            <div className='flex grid lg:grid-cols-2 md:grid-cols-1 my-4'>
                ...
                <div className=' flex flex-col justify-between'>
                    <div className='flex justify-center my-2'><p className='text-end md:text-start' style={{ width: "40%" }}> Device Sim Number :</p><input name='devciesim_no' onChange={getUserData} className=' ml-3 custum_input  p-1 ' style={{ width: "55%" }} /> </div>
