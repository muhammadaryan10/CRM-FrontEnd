  ...
  return (
    <div className='flex h-[100vh] bg-black'>
      ...
      <div className='rounded-xl m-2 p-2 w-100 overflow-y-scroll bg' style={{ backgroundColor: "#F0F0F0" }}>
        ...
        {/* <div className='flex py-3 my-3 justify-between'> <h1 className='text-4xl font-bold text-uppercase text-black'>   </h1> </div>
...
export default DataLogSuperVisor;
