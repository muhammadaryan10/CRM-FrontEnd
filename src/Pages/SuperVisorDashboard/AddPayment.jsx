...
export default function AddPayment() {
    ...
    const addNewPayment = async () => {
        const { representative, recieved_renewal, remarks, renewal_id } = addPayment
        if (representative, recieved_renewal, remarks, renewal_id) {
            try {
                ...
                if (response.status === 200) {
                   ...
                   toast.success('Payment Addded Succfully')
                }
            } catch (error) {
                        ...
                        <div className='grid grid-cols-2 m-2'>
                            <div>
                                <div className='my-4    '>
                                    ...
                                    <select class='input-field  ml-4 p-1  border bg-white' name='status' onChange={OptionSelect} style={{ width: "55%" }} aria-label=".form-select-lg example">
                            ...
                            <div>
                                {additionalFields && (<div className='my-4    '>
                                    <label className='mr-3 w-40' >Submitted Amount :</label><input onChange={getUserdata} name="recieved_renewal" className='w-60 p-2 border border-black rounded-2' />
                                </div>
                                )}
                                <label className='mr-3 w-40' >Remarks :</label><input onChange={getUserdata} name="remarks" className='w-60 p-2 border border-black rounded-2' />
                            </div>
                        </div>
