...
const AttendenceReportSuperAdmin = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await fetch("http://127.0.0.1:8000/api/getallattend");
      if (!res.ok) {
  ...
  return (
    <div className='flex h-[100vh] bg-black'>
      ...
      <div className='bg-white rounded-xl m-2 p-2 w-100 overflow-y-scroll bg'>
        ...
        <h1 className='text-4xl font-bold text-uppercase text-black py-3 my-3'>Daily Attendence Report </h1>
