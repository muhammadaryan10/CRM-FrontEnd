...
export default function RenewalLogSuperAdmin({ data }) {
  ...
  useEffect(() => {
    if (data && data.removal) {
      console.log("New data received:", data.removal);
      setTableData(data.removal);
    }
  }, [data]);
                                            ...
                                            <table className="min-w-full">
                                                ...
                                                <tbody>
                                                    <tr className="bg-white border-2 border-gray-200">
                                                        <td className="text-xs text-gray-900 font-light p-2  whitespace-nowrap border border-gray-200"> JU-7025</td>
                                                        ...
                                                        <td className="text-xs text-gray-900 font-light p-2  whitespace-nowrap border border-gray-200">Blue</td>
                                                        <td className="text-xs text-gray-900 font-light p-2  whitespace-nowrap border border-gray-200">
                                                            1995
                                                        </td>
                                                        <td className="text-xs text-gray-900 font-light p-2  whitespace-nowrap border border-gray-200">
