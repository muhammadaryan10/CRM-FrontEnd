...
const VehicleSuperAdmin = () => {
        ...
        () => [
            ...
            },
            {
                ...
                Cell: ({ renderedCellValue, row }) => (
                    <Link className='text-blue-500 underline' to={`/superAdmin/vehiclesInfo/:reg_no/${row.original.registeration_no}`}>
                        {renderedCellValue}
                    </Link>
                ),
            },
    ...
    const table = useMaterialReactTable({
        ...
        muiTableBodyRowProps: ({ row }) => ({
            onClick: (event) => {
                navigate(`/superAdmin/vehiclesInfo/${row.original.registeration_no}`)
...
export default VehicleSuperAdmin;
