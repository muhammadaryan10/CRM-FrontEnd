...
const AllUserCS = () => {
        ...
        () => [
            ...
            },
            {
                ...
                Cell: ({ renderedCellValue, row }) => (
                    <Link className='text-blue-500 underline' to={`/cs/userInfo/${row.original.registeration_no}`}>
                        {renderedCellValue}
                    </Link>
                ),
            },
    ...
    const table = useMaterialReactTable({
        ...
        muiTableBodyRowProps: ({ row }) => ({
            onClick: (event) => {
                console.info(event, row.original.registeration_no);
            },
            // sx: {
